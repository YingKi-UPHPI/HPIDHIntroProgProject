...
format: 
  html:
    ...
    code-fold: true   # "safety net" for echo: false
...
#those cell become NaNs because they don't fall into any of the categories
ageheadphoneplot = hearingcleaned.dropna(subset=['Daily_Headphone_Use'])

ct = pd.crosstab(ageheadphoneplot['Age_group'], 
                 ageheadphoneplot['Daily_Headphone_Use'])

fig, ax = plt.subplots(figsize=(12, 6), constrained_layout = True)

ct.plot(kind='bar', stacked=True, ax = ax, colormap = 'viridis')
plt.legend(title="Usage Duration", loc = 'upper left', bbox_to_anchor = (1.0, 1.0))
plt.xlabel("Age Group")
plt.ylabel("Percentage of Age Group")
plt.xticks(rotation = 45, ha = 'right')
plt.title("Headphone Usage by Age")
...
## Analysing interest & willingness to pay for hearing health app
```{python}
...
gen_bargraph = ax1.bar(general_app_interest.index, general_app_interest.values, color=yesmaybeno_colours)
...
paid_bargraph = ax2.bar(paid_app_interest.index, paid_app_interest.values, color=yesmaybeno_colours)
