...
## Analysing Headphone Usage by Age
```{python}
...
## Analysing Headphone Usage by Important Sounds Missed
```{python}
...
missed_sounds_18_24_table = (
    ...
    .rename_axis("Missed Important Sounds?", axis = 1)
)
...
increase the frequency of missing important sounds. In fact, there seems to be a 
reduced frequency of missing important sounds with higher frequency usage of 
headphone. Deeper analysis (e.g. Chi Square) needs to be done.

## Analysing Headphone Usage by Belief To Care For Hearing Early
```{python}
belief_18_24 = (
...
increase belief for early hearing care.
